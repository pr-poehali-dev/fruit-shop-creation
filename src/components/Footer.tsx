...
const Footer = () => {
  ...
  const shareText = '🌱 Качественные саженцы плодовых деревьев и декоративных растений в Барнауле';
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
            ...
            {showShareMenu && (
              <div className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 bg-white text-gray-800 rounded-lg shadow-xl p-2 min-w-[200px] z-50">
                <button
                  onClick={copyLink}
                  className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-gray-100 rounded transition-colors text-left"
                >
